...
public class ProductService {
    ...
    public CreateProductResponseDTO createProduct(CreateProductRequestDTO requestDTO){
        ...
        Set<Categories> setCategories = requestDTO.getProductCategories().stream().map(categoryId -> productCategoriesRepository.findById(categoryId).get()).filter(Objects::nonNull).collect(Collectors.toSet());
    ...
    public CreateProductResponseDTO toCreateProductResponseDTO(Products product) {
        ...
        createProductResponseDTO.setCategories(product.getCategories().stream().map(Categories::getCategoryName).collect(Collectors.toList()));
